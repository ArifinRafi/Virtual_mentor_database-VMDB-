    ...
    return (
      ...
      <div className="card-body">
        ...
        <div className="form-control mt-6">
          <button type='submit' className="btn text-white bg-gradient-to-r  from-red-500 to-blue-700 shadow-2xl">{loading == true ? <CircularProgress size={10} isIndeterminate color='green.300' /> : 'Login'} </button>
