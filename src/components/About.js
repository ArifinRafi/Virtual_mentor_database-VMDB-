...
const About = () => {
    return (
           ...
           <div className='grid grid-cols-2 py-24 px-20 bg-gray-200 rounded-xl h-full'>
            <div className=' py-12 '>
                ...
                <FaMale size='2rem' color='green' className='mr-3' />
                Know your Mentor's profile
                </h3>
                <h3 className='text-xl my-12 mx-40 flex items-center'>
                <FaBook size='2rem' color='green' className='mr-3' />
                Know their research interest
                </h3>
                <h3 className='text-xl my-12 mx-40 flex items-center'>
                <FaRunning size='2rem' color='green' className='mr-3' />
